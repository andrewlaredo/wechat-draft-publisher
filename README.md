...
- 🤖 **AI 智能创作助手 (Human-in-the-Loop)**：内置 Gemini 2.5 大模型支持，可按受众与风格生成包含完整 Front Matter 的结构化 Markdown 文章；支持导入本地参考文档（RAG 知识增强），所有 AI 内容仅作为草稿由作者最终审核，尊重创作者主导权。
...
- [二、核心功能全景介绍](#二核心功能全景介绍)
  ...
  - [2.2 AI 智能创作助手与本地资料导入](#22-ai-智能创作助手与本地资料导入)
...
### 2.2 AI 智能创作助手与本地资料导入

点击顶栏「AI 智能撰文」即可打开强大的 AI 创作工作台：
