...
app.get('/api/health', (_req, res) => {
  res.json({ status: 'ok', runtime: 'vercel-serverless', timestamp: Date.now() });
});
...
// API 8.1: Get specific draft details
...
// API 8.3: Submit draft for free publishing
...
app.get('/api/draft', (_req, res) => {
  res.json({ draft: inMemoryDraft });
});

app.post('/api/draft', (req, res) => {
  inMemoryDraft = req.body;
...
// API 11: Universal AI Article Generation
